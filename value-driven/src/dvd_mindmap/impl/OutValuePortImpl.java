...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Out Value Port</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link dvd_mindmap.impl.OutValuePortImpl#getBelongsToValueExchange <em>Belongs To Value Exchange</em>}</li>
 *   <li>{@link dvd_mindmap.impl.OutValuePortImpl#getValueObject <em>Value Object</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class OutValuePortImpl extends NodeImpl implements OutValuePort {
	/**
	...
	protected EClass eStaticClass() {
		return Dvd_mindmapPackage.Literals.OUT_VALUE_PORT;
	}
		...
		if (belongsToValueExchange != null && belongsToValueExchange.eIsProxy()) {
			...
			if (belongsToValueExchange != oldBelongsToValueExchange) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Dvd_mindmapPackage.OUT_VALUE_PORT__BELONGS_TO_VALUE_EXCHANGE, oldBelongsToValueExchange, belongsToValueExchange));
			}
		}
	...
	public void setBelongsToValueExchange(ValueExchange newBelongsToValueExchange) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dvd_mindmapPackage.OUT_VALUE_PORT__BELONGS_TO_VALUE_EXCHANGE, oldBelongsToValueExchange, belongsToValueExchange));
	}
	...
	public ValueObject getValueObject() {
		if (valueObject != null && valueObject.eIsProxy()) {
			...
			if (valueObject != oldValueObject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Dvd_mindmapPackage.OUT_VALUE_PORT__VALUE_OBJECT, oldValueObject, valueObject));
			}
		}
		return valueObject;
	}
	...
	public void setValueObject(ValueObject newValueObject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dvd_mindmapPackage.OUT_VALUE_PORT__VALUE_OBJECT, oldValueObject, valueObject));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Dvd_mindmapPackage.OUT_VALUE_PORT__BELONGS_TO_VALUE_EXCHANGE:
				if (resolve) return getBelongsToValueExchange();
				return basicGetBelongsToValueExchange();
			case Dvd_mindmapPackage.OUT_VALUE_PORT__VALUE_OBJECT:
